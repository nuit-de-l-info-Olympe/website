    ...
    >
      <Stack spacing={2} sx={{ mb: 5, position: "relative" }}>
        ...
        <Typography fontWeight="body2" paragraph>
          ...
          sembler complexe, mais il concerne chacun d'entre nous. Ensemble, nous
          pouvons démêler les fausses informations des solutions réelles. C'est
          le moment d'agir, informés et inspirés.
        </Typography>
        <Typography fontWeight="body2" paragraph>
          ...
          données chiffrées et des sources fiables. Nous croyons en la puissance
          des actions collectives et en la nécessité d'une approche holistique
        ...
        <Typography fontWeight="body2" paragraph>
          ...
          positives, du niveau individuel aux politiques publiques. N'oublions
          personne en chemin.
        </Typography>
        <Typography fontWeight="body2" paragraph>
          Explorez, Apprenez, Agissez : Que vous soyez novice en matière de
          climat ou déjà engagé, ce site offre des ressources diverses pour tous
          les niveaux de connaissances. Ensemble, nous pouvons comprendre,
          inspirer et créer un avenir durable.
        </Typography>
      </Stack>
    </Box>
  );
